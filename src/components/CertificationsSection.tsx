...
export const CertificationsSection = () => {
  ...
  return (
    <section id="certifications" className="py-16 px-4 md:px-8 bg-gradient-to-br from-background via-secondary/5 to-background">
      <div className="w-full max-w-7xl mx-auto">
        ...
        {activeFilter === "all" ? (
          <div className="px-2 sm:px-4 overflow-x-hidden">
